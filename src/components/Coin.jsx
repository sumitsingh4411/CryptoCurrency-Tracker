  ...
  return (
    <Link to={`/coins/${coin.id}`} className="text-decoration-none my-1 coin">
      <li className="coinlist-item list-group-item list-group-item-action d-flex justify-content-between align-items-center text-dark">
       <span>{coin.name}<img className="coinlist-image" src={coin.image} alt="" /></span>
        <span className="text-decoration-none">Rs {coin.current_price} </span>
        <span className="text-decoration-none">{coin.market_cap} </span>
